...
function setup() {
    ...
    lifeP = createP(); //lifespan (goes up to lifespan)
...
function draw() { //recurring method
    background(0);
    population.run();
    lifeP.html("Life Elapsed: " + count);
    simulationNumber.html("Simulation Number: " + numSimulations);
    targetHits.html("Times Target Reached: " + hitTarget);
